...
* 构造识别文法所有活前缀的 NFA：
  1.  ${\displaystyle State(i): X \rightarrow X_1 X\_2 ... X_{i-1} \cdot X_i...X_n}$

      ${\displaystyle State(j):X \rightarrow X_1 X\_2...X_i \cdot X_{i+1} ... X_n}$
...
* _PS_：构成识别一个文法活前缀的 DFA 的项目集（状态）的全体称为文法的 **LR(0) 项目集规范族**。
