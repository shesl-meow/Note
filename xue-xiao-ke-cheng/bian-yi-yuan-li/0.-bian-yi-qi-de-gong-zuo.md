...
> 参考网址：
>
> * [http://www.ntu.edu.sg/home/ehchua/programming/cpp/gcc_make.html](http://www.ntu.edu.sg/home/ehchua/programming/cpp/gcc_make.html)
> * [https://linux.die.net/man/1/gcc](https://linux.die.net/man/1/gcc)
> * [https://sourceware.org/ml/binutils/2009-08/msg00193.html](https://sourceware.org/ml/binutils/2009-08/msg00193.html)
> * [https://web.stanford.edu/class/cs193d/handouts/make.pdf](https://web.stanford.edu/class/cs193d/handouts/make.pdf)
...
![compiler](../../.gitbook/assets/compiler-work.svg)

![compiler2](../../.gitbook/assets/compiler-work2.png)
...
![01](../../.gitbook/assets/gcc-preprocess1.png)

......

![02](../../.gitbook/assets/gcc-preprocess2.png)

_PostScript_：关于 `gcc` 的 `-o` 选项缺省的问题：

> If **-o** is not specified, the default is to put an executable file in _a.out_, the object file for _source.suffix_ in _source.o_, its assembler file in _source.s_, a precompiled header file in _source.suffix.gch_, and all preprocessed C source on standard output.
